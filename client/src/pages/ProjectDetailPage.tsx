...
import { FilteredTasksEmptyState, TasksEmptyState } from '../components/ui/EmptyState';
  ...
  return (
    <div>
      ...
      {!tasksLoading && !hasAnyTasks && (
        <TasksEmptyState onCreateClick={() => setModalOpen(true)} />
      )}

      {!tasksLoading && hasAnyTasks && !hasFilteredTasks && <FilteredTasksEmptyState />}
